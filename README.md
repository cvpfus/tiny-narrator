...
`/api/evidence-bundle` returns a copyable JSON bundle of the main judging receipts, including `PUBLIC_BASE_URL`. The Submission Readiness panel includes a Copy Evidence button that writes this bundle to the clipboard.
